...
// src/packages/react-dom/cjs/react-dom.development.js
var require_react_dom_development = __commonJS({
  "src/packages/react-dom/cjs/react-dom.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
        ...
        var { logHook, logLibraryMethod } = (init_log(), __toCommonJS(log_exports));
        logLibraryMethod(getComponentNameFromFiber);
        ...
        function getNextLanes(root2, wipLanes) {
          ...
          if (entangledLanes !== NoLanes) {
            ...
            while (lanes > 0) {
              ...
              logHook("getNextLanes_entangledLanes", entanglements[index2]);
              lanes &= ~lane;
            }
          }
          return nextLanes;
        ...
        function markRootSuspended(root2, suspendedLanes) {
          ...
          logHook("markRootSuspended", suspendedLanes, root2.suspendedLanes, root2.pingedLanes);
          var expirationTimes = root2.expirationTimes;
        ...
        function markRootPinged(root2, pingedLanes, eventTime) {
          ...
          logHook("markRootPinged", root2.pingedLanes);
        }
        ...
        function markRootEntangled(root2, entangledLanes) {
          logHook("markRootEntangled", entangledLanes);
        ...
        function updateDOMProperties(domElement, updatePayload, wasCustomComponentTag, isCustomComponentTag) {
          for (var i = 0; i < updatePayload.length; i += 2) {
            ...
            if (propKey === STYLE) {
              ...
              logHook("updateDOMProperties", domElement, "setValueForStyles");
            } else if (propKey === DANGEROUSLY_SET_INNER_HTML) {
              setInnerHTML(domElement, propValue);
              logHook("updateDOMProperties", domElement, "setInnerHTML");
            } else if (propKey === CHILDREN) {
              setTextContent(domElement, propValue);
              logHook("updateDOMProperties", domElement, "setTextContent");
            } else {
              setValueForProperty(domElement, propKey, propValue, isCustomComponentTag);
              logHook("updateDOMProperties", domElement, "setValueForProperty");
            }
          }
        }
        ...
        function commitUpdateQueue(finishedWork, finishedQueue, instance) {
          ...
          if (effects !== null) {
            logHook("commitUpdateQueue", finishedWork, effects);
          ...
          function placeChild(newFiber, lastPlacedIndex, newIndex) {
            ...
            if (current2 !== null) {
              ...
              if (oldIndex < lastPlacedIndex) {
                ...
                logHook("placeChild", "move", newFiber, lastPlacedIndex);
                return lastPlacedIndex;
              } else {
                logHook("placeChild", "stay", newFiber, oldIndex);
                return oldIndex;
              }
            } else {
              newFiber.flags |= Placement;
              logHook("placeChild", "insertion", newFiber, lastPlacedIndex);
              return lastPlacedIndex;
            }
          }
        ...
        function createRootErrorUpdate(fiber, errorInfo, lane) {
          ...
          logHook("createRootErrorUpdate", executionContext, fiber, update);
          return update;
        }
        function createClassErrorUpdate(fiber, errorInfo, lane) {
          ...
          if (typeof getDerivedStateFromError === "function") {
            ...
            logHook("createClassErrorUpdate", "getDerivedStateFromError", executionContext, fiber, update);
          }
          ...
          if (inst !== null && typeof inst.componentDidCatch === "function") {
            ...
            logHook("createClassErrorUpdate", "componentDidCatch", executionContext, fiber, update);
          }
          return update;
        }
        function attachWakeableListeners(suspenseBoundary, root2, wakeable, lanes) {
          if (suspenseBoundary.mode & ConcurrentMode) {
            ...
            var threadIDs;
            logHook("attachWakeableListeners", root2, wakeable, lanes);
            if (pingCache === null) {
          ...
          do {
            switch (workInProgress2.tag) {
              case HostRoot: {
                ...
                logHook("ErrorUpdate on Root", "render", update, workInProgress2);
                return;
              }
              case ClassComponent:
                var errorInfo = value;
                ...
                if ((workInProgress2.flags & DidCapture) === NoFlags && (typeof ctor.getDerivedStateFromError === "function" || instance !== null && typeof instance.componentDidCatch === "function" && !isAlreadyFailedLegacyErrorBoundary(instance))) {
                  ...
                  logHook("ErrorUpdate on ClassComponent", "render", _update, workInProgress2);
                  return;
                }
                break;
            }
        ...
        function bubbleProperties(completedWork) {
          ...
          logHook("bubbleProperties", completedWork, didBailout);
          if (!didBailout) {
        ...
        function completeWork(current2, workInProgress2, renderLanes2) {
          ...
          logHook("completeWork", current2, workInProgress2);
        ...
        function updateClassComponent(current2, workInProgress2, Component, nextProps, renderLanes2) {
          {
            switch (shouldError(workInProgress2)) {
              ...
              case true: {
                ...
                enqueueCapturedUpdate(workInProgress2, update);
                logHook("ErrorUpdate on ClassComponent", "render", update, workInProgress2);
                break;
              }
            }
            if (workInProgress2.type !== workInProgress2.elementType) {
        ...
        function scheduleWorkOnFiber(fiber, renderLanes2) {
          logHook("changeLanes", "scheduleWorkOnFiber", fiber.lanes, mergeLanes(fiber.lanes, renderLanes2));
          fiber.lanes = mergeLanes(fiber.lanes, renderLanes2);
          var alternate = fiber.alternate;
          if (alternate !== null) {
            alternate.lanes = mergeLanes(alternate.lanes, renderLanes2);
        ...
        function bailoutOnAlreadyFinishedWork(current2, workInProgress2, renderLanes2) {
          ...
          if (!includesSomeLane(renderLanes2, workInProgress2.childLanes)) {
            {
              logHook("bailoutOnAlreadyFinishedWork", "skip children");
              return null;
            }
          }
          cloneChildFibers(current2, workInProgress2);
          logHook("bailoutOnAlreadyFinishedWork", "cloneChildFibers", workInProgress2.child);
          return workInProgress2.child;
        }
        ...
        function beginWork(current2, workInProgress2, renderLanes2) {
          ...
          logHook("beginWork", current2, workInProgress2);
          if (current2 !== null) {
            var oldProps = current2.memoizedProps;
            var newProps = workInProgress2.pendingProps;
          ...
          logHook("changeLanes", "beginWork", workInProgress2.lanes, NoLanes);
          workInProgress2.lanes = NoLanes;
          switch (workInProgress2.tag) {
            case IndeterminateComponent: {
        ...
        function commitBeforeMutationEffects_complete() {
          while (nextEffect !== null) {
            ...
            try {
              logHook("commitBeforeMutationEffectsOnFiber", fiber);
        ...
        function commitMutationEffects_complete(root2) {
          while (nextEffect !== null) {
            ...
            setCurrentFiber(fiber);
            try {
              logHook("commitMutationEffectsOnFiber", fiber);
        ...
        function commitMutationEffectsOnFiber(finishedWork, root2) {
          ...
          switch (primaryFlags) {
            case Placement: {
              logHook("updateDOM", finishedWork, "commitPlacement");
            ...
            case PlacementAndUpdate: {
              ...
              logHook("updateDOM", finishedWork, "commitWork");
        ...
        function commitLayoutMountEffects_complete(subtreeRoot, root2, committedLanes) {
          while (nextEffect !== null) {
            ...
            if ((fiber.flags & LayoutMask) !== NoFlags) {
              ...
              setCurrentFiber(fiber);
              try {
                logHook("commitLayoutEffectOnFiber", fiber);
        ...
        function markUpdateLaneFromFiberToRoot(sourceFiber, lane) {
          logHook("changeLanes", "markUpdateLaneFromFiberToRoot", sourceFiber.lanes, mergeLanes(sourceFiber.lanes, lane));
        ...
        function ensureRootIsScheduled(root2, currentTime) {
          ...
          if (existingCallbackPriority === newCallbackPriority && !(ReactCurrentActQueue$1.current !== null && existingCallbackNode !== fakeActCallbackNode)) {
            ...
            logHook("priorityNotChange", newCallbackPriority);
            return;
          }
          if (existingCallbackNode != null) {
            cancelCallback$1(existingCallbackNode);
          ...
          if (newCallbackPriority === SyncLane) {
            if (root2.tag === LegacyRoot) {
              ...
              logHook("scheduleCallback", "legacySync", performSyncWorkOnRoot.name);
              scheduleLegacySyncCallback(performSyncWorkOnRoot.bind(null, root2));
            } else {
              logHook("scheduleCallback", "sync", performSyncWorkOnRoot.name);
            ...
            }
            {
              if (ReactCurrentActQueue$1.current !== null) {
                ...
                logHook("scheduleCallback", "microtask", flushSyncCallbacks.name);
            ...
            logHook("scheduleCallback", "concurrent", performConcurrentWorkOnRoot.name, schedulerPriorityLevel);
        ...
        function performConcurrentWorkOnRoot(root2, didTimeout) {
          ...
          logHook("shouldTimeSlice", shouldTimeSlice);
          ...
          ensureRootIsScheduled(root2, now());
          if (root2.callbackNode === originalCallbackNode) {
            logHook("continuationCallback", root2);
        ...
        function pushRenderLanes(fiber, lanes) {
          ...
          logHook("pushRenderLanes", fiber, lanes);
        }
        function popRenderLanes(fiber) {
          subtreeRenderLanes = subtreeRenderLanesCursor.current;
          pop(subtreeRenderLanesCursor, fiber);
          logHook("popRenderLanes", fiber);
        }
        ...
        function renderRootSync(root2, lanes) {
          logHook("renderRootSync", root2, lanes);
          var prevExecutionContext = executionContext;
        ...
        function renderRootConcurrent(root2, lanes) {
          logHook("renderRootConcurrent", root2, lanes);
          var prevExecutionContext = executionContext;
          executionContext |= RenderContext;
          var prevDispatcher = pushDispatcher();
          if (workInProgressRoot !== root2 || workInProgressRootRenderLanes !== lanes) {
        ...
        function commitRootImpl(root2, renderPriorityLevel) {
          ...
          if (subtreeHasEffects || rootHasEffect) {
            ...
            logHook("commitBegin", "\u6709effect\u9700\u8981\u5904\u7406", lanes, root2);
            ReactCurrentOwner$2.current = null;
        ...
        function flushPassiveEffectsImpl() {
          ...
          var prevExecutionContext = executionContext;
          executionContext |= CommitContext;
          logHook("commitBegin", "\u6709PassiveEffect\u9700\u8981\u5904\u7406", lanes, root2);
        ...
        function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error2) {
          ...
          logHook("ErrorUpdate on Root", "commit", update, rootFiber);
          if (root2 !== null) {
          ...
          while (fiber !== null) {
            if (fiber.tag === HostRoot) {
              ...
              if (typeof ctor.getDerivedStateFromError === "function" || typeof instance.componentDidCatch === "function" && !isAlreadyFailedLegacyErrorBoundary(instance)) {
                ...
                logHook("ErrorUpdate on ClassComponent", "commit", update, fiber);
                if (root2 !== null) {
                  markRootUpdated(root2, SyncLane, eventTime);
                  ensureRootIsScheduled(root2, eventTime);
                }
        ...
        function resetWorkInProgress(workInProgress2, renderLanes2) {
          ...
          if (current2 === null) {
            ...
            logHook("changeLanes", "resetWorkInProgress", workInProgress2.lanes, renderLanes2);
            workInProgress2.lanes = renderLanes2;
            workInProgress2.child = null;
            workInProgress2.subtreeFlags = NoFlags;
            ...
            workInProgress2.childLanes = current2.childLanes;
            logHook("changeLanes", "resetWorkInProgress", workInProgress2.lanes, current2.lanes);
            workInProgress2.lanes = current2.lanes;
            workInProgress2.child = current2.child;
            workInProgress2.subtreeFlags = NoFlags;
            workInProgress2.deletions = null;
...
// src/packages/react-dom/index.js
var require_react_dom = __commonJS({
  "src/packages/react-dom/index.js"(exports, module) {
    "use strict";
    if (false) {
      checkDCE();
      module.exports = null;
